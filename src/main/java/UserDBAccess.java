...
public class UserDBAccess {
    ...
    final static String URL = "jdbc:postgresql://54.93.65.5:5432/6Bogdan";
    ...
    public int isUserPwdOK(String user, String pwd) {
        ...
        try {
            ...
            // 5. execute a query
            String query = "SELECT id FROM useri_banca where nume='"+user+"' and parola='"+pwd+"'";
    ...
    public static void main(String[] args) {
        ...
        int gasit;
        gasit = udb.isUserPwdOK("babut rares", "1002");
